...
void Controller::keyAdd(SDL_Keycode qKey) {
...
void Controller::keyDown(SDL_Keycode qKey) {
	if (_keyList.find(qKey) == _keyList.end()) {
...
void Controller::keyUp(SDL_Keycode qKey) {
	if (_keyList.find(qKey) == _keyList.end()) {
		std::cout << "key input not in list of watched keys, add the key to the watched keys list\n";
	} else {
...
bool Controller::getKey(SDL_Keycode qKey) {
	if (_keyList.find(qKey) == _keyList.end()) {
		std::cout << "key input not in list of watched keys, add the key to the watched keys list\n";
	} else {
...
bool Controller::getKeyClicked(SDL_Keycode qKey) {
	if (_keyList.find(qKey) == _keyList.end()) {
		std::cout << "key input not in list of watched keys, add the key to the watched keys list\n";
	} else {
